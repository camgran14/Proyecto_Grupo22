...
for model_name, model in models.items():
    run_experiment(model, X_train, X_test, y_train, y_test, f"Linear_Regression_{model_name}_Experiments")
...
for model_name, model in models3.items():
    run_experiment(model, X_train, X_test, y_train, y_test, f"Polynomial_Regression_{model_name}_Experiments")
